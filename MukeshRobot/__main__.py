...
🌹ɪ ᴀᴍ ᴀɴ 📀 ᴀᴅᴠᴀɴᴄᴇᴅ 🎭 ᴀɴᴅ 🌱 sᴜᴘᴇʀғᴀsᴛ 🌼 ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ♨️ ᴀɴᴅ 🍒 ᴠᴄ 🍄 ᴘʟᴀʏᴇʀ 📣 ᴡɪᴛʜ 🕙 24𝐱7 🌀 ᴀᴄᴛɪᴠᴇ » ғᴏʀ 🗨️ ᴛᴇʟᴇɢʀᴀᴍ ♨️ ɢʀᴏᴜᴘs  🎸 ᴀɴᴅ 🏓  ᴄʜᴀɴɴᴇʟ 🎻

💐ғᴇᴇʟ 😍 ʟᴀɢ 📍 ғʀᴇᴇ 😇 ᴛᴏ 🕊️ ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ 🤖 ᴀɴᴅ 🩸 ᴇɴᴊᴏʏ ❥︎ sᴜᴘᴇʀ 💥 ʜɪɢʜ 💫 ǫᴜᴀʟɪᴛʏ ⚡ ᴍᴀɴᴀɢɪɴɢ ɢʀᴏᴜᴘ &   ᴘʟᴀʏ 🦞 ᴀᴜᴅɪᴏ 🎧 ᴀɴᴅ 🔊 ᴠɪᴅᴇᴏ 🌷
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🌱𝐒𝐎𝐔𝐑𝐂𝐄🌱", callback_data="qnrobot_"),
    ],
]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
                            url="https://t.me/EBD_524",
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="✯ вαϲк ✯", callback_data="QNROBOT_back"),
                    ],
                ]
            ),
        )
    elif query.data == "QNROBOT_back":
        first_name = update.effective_user.first_name 
        query.message.edit_text(
            PM_START_TEXT.format(escape_markdown(first_name), (START_IMG), BOT_NAME),
            reply_markup=InlineKeyboardMarkup(buttons),
...
def Music_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "Music_":
        query.message.edit_text(
            text=f"""
 **👀𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 🖤\n\n🌺ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ {dispatcher.bot.first_name} 🍷\n\n🌹𝐈 ᴀᴍ ᴀɴ 📀 ᴀᴅᴠᴀɴᴄᴇᴅ 🎭 ᴀɴᴅ 🌱 sᴜᴘᴇʀғᴀsᴛ 🌼 ᴠᴄ 🍄 ᴘʟᴀʏᴇʀ 📣 ᴡɪᴛʜ 🕙 24𝐱7 🌀 ᴀᴄᴛɪᴠᴇ » ғᴏʀ 🗨️ ᴛᴇʟᴇɢʀᴀᴍ ♨️ ᴄʜᴀɴɴᴇʟ 🎸 ᴀɴᴅ 🏓 ɢʀᴏᴜᴘs 🎻\n\n💐ғᴇᴇʟ 😍 ʟᴀɢ 📍 ғʀᴇᴇ 😇 ᴛᴏ 🕊️ ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ 🤖 ᴀɴᴅ 🩸 ᴇɴᴊᴏʏ ❥︎ sᴜᴘᴇʀ 💥 ʜɪɢʜ 💫 ǫᴜᴀʟɪᴛʏ 🦞 ᴀᴜᴅɪᴏ 🎧 ᴀɴᴅ 🔊 𝐕𝐢𝐝𝐞𝐨 🌷\n\n☆............𝙱𝚈 » [ǫɴ ʀᴏʙᴏᴛ](https://t.me/QN_ROBOT)............☆ 💞** 
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != {OWNER_ID} and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [QN ROBOT](https://t.me/QN_ROBOT)"
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://telegra.ph/file/fe1063af99b26507a5e15.jpg",
                caption=f"""
{dispatcher.bot.first_name}

╔═════ஜ۩۞۩ஜ═════╗

  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝗤𝗡 𝗥𝗢𝗕𝗢𝗧](https://t.me/QN_ROBOT)♨️
